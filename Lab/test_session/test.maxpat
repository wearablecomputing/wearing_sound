...
,
					"patching_rect" : [ 55.0, 83.486880999999983, 42.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 55.0, 120.0, 150.0, 33.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 55.0, 173.0, 138.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 138.0, 83.486880999999983, 50.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 55.0, 43.0, 133.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 27.0, 260.0, 616.444444954395294, 278.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-1::obj-11" : [ "live.text[7]", "live.text", 0 ],
			"obj-1::obj-120" : [ "live.gain~[1]", "live.gain~", 0 ],
			"obj-1::obj-15" : [ "StartTime[4]", "StartTime", 0 ],
			"obj-1::obj-16" : [ "Speed[2]", "Speed", 0 ],
			"obj-1::obj-18" : [ "Duration[3]", "Duration", 0 ],
			"obj-1::obj-188" : [ "gswitch2[33]", "gswitch2[13]", 0 ],
			"obj-1::obj-189" : [ "gswitch2[32]", "gswitch2[12]", 0 ],
			"obj-1::obj-190" : [ "gswitch2[31]", "gswitch2[11]", 0 ],
			"obj-1::obj-191" : [ "gswitch2[30]", "gswitch2[10]", 0 ],
			"obj-1::obj-192" : [ "gswitch2[29]", "gswitch2[9]", 0 ],
			"obj-1::obj-193" : [ "gswitch2[28]", "gswitch2[7]", 0 ],
			"obj-1::obj-29" : [ "gswitch2[41]", "gswitch2[40]", 0 ],
			"obj-1::obj-43" : [ "live.text[8]", "live.text", 0 ],
			"obj-1::obj-44" : [ "live.text[5]", "live.text", 0 ],
			"obj-1::obj-49" : [ "live.text[6]", "live.text", 0 ],
			"obj-1::obj-50" : [ "live.toggle[3]", "live.toggle", 0 ],
			"obj-1::obj-51" : [ "live.toggle[6]", "live.toggle", 0 ],
			"obj-1::obj-53" : [ "Cutoff[5]", "Cutoff", 0 ],
			"obj-1::obj-67" : [ "Resonance[2]", "Res", 0 ],
			"obj-1::obj-90" : [ "Pitch Shift[1]", "Pitch Shift", 0 ],
			"obj-44" : [ "number[7]", "number[7]", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
